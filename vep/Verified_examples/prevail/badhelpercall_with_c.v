...
Definition Real_tag := (Anormal nil Ebpf_Local_init ((Other ebpf_type Ebpf_t (Accessable (Vlop Vnth (Ez_val (-1)) (Vlist_vari 12%positive)) (Ez_val 1))) :: Ebpf_Sep_init) :: nil , O) :: nil.
